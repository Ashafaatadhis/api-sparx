...
const getAll = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.subGenre.findMany({
...
const insertData = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.subGenre.create({
        data,
    });
    return result;
});
...
const editData = (data, id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.subGenre.update({
        data,
        where: {
            id: parseInt(id),
        },
...
const deleteData = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const find = yield prisma_1.default.subGenre.findFirst({
        where: {
            id: parseInt(id),
        },
    });
    if (!find)
        return false;
    const result = yield prisma_1.default.subGenre.delete({
        where: {
            id: parseInt(id),
        },
    });

...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\CODING\\sparx\\api-sparx\\src\\migration",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "D:\\CODING\\sparx\\api-sparx\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../.env",
  ...
  "inlineSchemaHash": "f509517e6594fbe3451d9dd0168cad7e6af5ba661b4bf62b2c69c7e23a6a734a",
  "copyEngine": true
}
...
path.join(process.cwd(), "src/migration/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/migration/schema.prisma")
